...
<serviceModel xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" name="p.WebUI.Azure" generation="1" functional="0" release="0" Id="87dcdae9-0266-42d3-9209-6bc78079148c" dslVersion="1.2.0.0" xmlns="http://schemas.microsoft.com/dsltools/RDSM">
  <groups>
    <group name="p.WebUI.AzureGroup" generation="1" functional="0" release="0">
      ...
      <components>
        <groupHascomponents>
          <role name="p.WebUI" generation="1" functional="0" release="0" software="D:\Excite\PhotographyProject\p.WebUI.Azure\csx\Debug\roles\p.WebUI" entryPoint="base\x64\WaHostBootstrapper.exe" parameters="base\x64\WaIISHost.exe " memIndex="1792" hostingEnvironment="frontendadmin" hostingEnvironmentVersion="2">
            <componentports>
  ...
  <implements>
    <implementation Id="de12bfa6-403b-42a2-b962-c568dca1042d" ref="Microsoft.RedDog.Contract\ServiceContract\p.WebUI.AzureContract@ServiceDefinition">
      <interfacereferences>
        <interfaceReference Id="af1225e6-1677-4d75-a122-eb31b616feea" ref="Microsoft.RedDog.Contract\Interface\p.WebUI:Endpoint1@ServiceDefinition">
          <inPort>
            <inPortMoniker name="/p.WebUI.Azure/p.WebUI.AzureGroup/p.WebUI:Endpoint1" />
          </inPort>
        </interfaceReference>
